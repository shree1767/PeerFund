    ...
    <div className="py-24 px-6 flex justify-center">
      <div className="flex justify-center flex-col md:w-2/3">
          ...
          <div className="flex-1 sm:py-0 py-4">
            <div className="flex flex-col justify-start flex-wrap">
              ...
              <small className="text-gray-500">
                {expired
                  ? "Expired"
                  : daysRemaining(project.expiresOn) + " left"}
              </small>
            </div>
        ...
        <div className="w-full bg-gray-300 mt-4">
          <div
            className="bg-green-600 text-xl font-medium text-green-100 text-center p-0.5 leading-none rounded-l-full h-1 max-w-full"
            style={{
        ...
        <div className="flex justify-start space-x-2 mt-4 mb-8">
          {project?.status === 0 ? (
            <button
              type="button"
              ...
              project?.status === 1 ? (
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={() => setGlobalState("shareModal", "scale-100")}
                  >
                    Share
                  </button>
                </>
